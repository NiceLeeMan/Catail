...
export function CompanyListError({ onRetry }: CompanyListErrorProps) {
  return (
    <div
      role="alert"
      className="flex w-full flex-col items-center justify-center gap-4 rounded-xl border border-white/[0.08] bg-[#131B2E] py-24 text-center"
    >
