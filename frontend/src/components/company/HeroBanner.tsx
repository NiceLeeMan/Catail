  ...
  return (
    ...
    >
      <div className="mx-auto box-border flex h-full w-full max-w-[1280px] flex-col gap-2 px-8 pt-12">
        <h1 className="text-[32px] font-bold leading-normal text-dark-text-primary">기업 탐색</h1>
        <p className="text-[15px] font-normal leading-normal text-dark-text-secondary">
